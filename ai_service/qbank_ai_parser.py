...
5. For MCQ: options array must have 4 items like ["A) option1", "B) option2", "C) option3", "D) option4"]
...
9. difficultyLevel: 2 for MCQ, 3 for 3-mark, 4 for 5-mark
10. Include code snippets as part of the question text

Return ONLY a valid JSON array, no markdown, no explanation:
[
  {{"text": "question text", "questionType": "MCQ", "marks": 1, "options": ["A) opt1", "B) opt2", "C) opt3", "D) opt4"], "correctAnswer": "", "topic": "Topic Name", "difficultyLevel": 2}},
